...
pub fn render(
    ...
    let name_pcq = name_pc.to_string();
    let name_pcq = quote!(#name_pcq);
    ...
    out.push(quote! {
        ...
        impl #name_pc {
            ...
            pub fn ptr() -> *const #base::RegisterBlock {
                ksymbol!(&mut *klee_statics::#name_pc.get_mut(), #name_pcq);
                unsafe { klee_statics::#name_pc.get_ref() as *const _ }
            }
